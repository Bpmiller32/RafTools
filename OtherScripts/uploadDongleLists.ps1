...
Set-Location -Path "C:\Users\billym\Documents\DirMakerServer\DongleLists"
svn cleanup
svn update

# Define FTP server details
$ftpServer = "ftp://174.21.134.98"
$ftpUsername = "raftech"
$ftpPassword = 'V0m|tT!'
$localFolder = "C:\Users\billym\Documents\DirMakerServer\DongleLists"
