...
namespace OverwatchApi.Workers
{
    ...
    // - Implement SvnSharp to remove Process calls to Svn, enable better check on Svn credentials and path
    public class RoyalWorker
    {
        ...
        public void CheckInput()
        {
            ...
            try
            {
                // Do work here, need to implement SvnSharp            
            }
            catch (System.Exception)
            {
                throw new Exception("Svn failed, check credentials or Svn path");
            }
        }
